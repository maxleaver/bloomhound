<template>
  <div class="control is-clearfix time-picker">
    <input
      class="display-time input"
      :id="id"
      v-model="displayTime"
...
export default {
  ...
  methods: {
    ...
    renderFormat(newFormat) {
      let format = newFormat || this.format;

      if (!format || !format.length) {
        format = 'HH:mm';
      }

      this.hourType = this.checkAcceptingType(CONFIG.HOUR_TOKENS, format, 'HH');
      this.minuteType = this.checkAcceptingType(CONFIG.MINUTE_TOKENS, format, 'mm');
      this.secondType = this.checkAcceptingType(CONFIG.SECOND_TOKENS, format);
      this.apmType = this.checkAcceptingType(CONFIG.APM_TOKENS, format);
    ...
    renderList(listType, intervalType) {
